...
# e.g.
# $SONGEXPLORER_BIN misses.sh `pwd`/groundtruth-data/round2/20161207T102314_ch1_p2-detected.csv,`pwd`/groundtruth-data/round2/20161207T102314_ch1_p2-predicted-1.0pr.csv
