...
# generate per-class probabilities from .tf files
 
# probabilities.py <logdir> <model> <tffile> <context> <shift> <stride> [<labels>, <prevalences>]

# e.g.
# deepsong probabilities.py `pwd`/trained-classifier 1k `pwd`/groundtruth-data/20161207T102314_ch1_p1.tf 204.8 0 1.6 mel-pulse,mel-sine,ambient 0.1,0.1,0.8
