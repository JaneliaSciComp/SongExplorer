...
try:
  ...
  _, context_ms, shiftby_ms, optimizer, learning_rate, audio_read_plugin, audio_read_plugin_kwargs, video_read_plugin, video_read_plugin_kwargs, video_findfile, video_bkg_frames, data_loader_queuesize, data_loader_maxprocs, architecture, model_parameters, logdir, data_dir, labels_touse, kinds_touse, nsteps, restore_from, save_and_validate_period, mini_batch, testing_files, audio_tic_rate, audio_nchannels, video_frame_rate, video_frame_width, video_frame_height, video_channels, batch_seed, weights_seed, deterministic, kfold, ifolds = sys.argv[:35]
