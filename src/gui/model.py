...
def init(_bokeh_document, _configuration_file):
    ...
    sys.path.append(os.path.dirname(video_findfile))
    video_findfile = importlib.import_module(os.path.basename(video_findfile)).video_findfile
