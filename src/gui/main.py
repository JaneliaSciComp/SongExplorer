                       ...
                       row(
                           column(
                               ...
                               row(V.frequency_p_string,
                                   ...
                                   V.replicates_string,
                                   V.batch_seed_string,
                                   V.weights_seed_string,
                                   V.precision_recall_ratios_string,
                                   width=M.gui_width_pix-420)),
                           column(row(V.cluster_these_layers, width=105),
                                  V.editconfiguration, width=105),
                           column(
                               row(V.cluster_algorithm,
                                   V.pca_fraction_variance_to_retain_string,
                                   width=210),
                               row(V.tsne_perplexity_string,
                                   V.tsne_exaggeration_string,
                                   width=210),
                               row(V.umap_neighbors_string,
