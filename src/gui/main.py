...
main_content = row(column(cluster_buttons,
                          ...
                          V.p_waveform if M.waveform==1 else Spacer(),
                          V.p_spectrogram if M.spectrogram==1 else Spacer(),
                          Spacer(height=10),
                   ...
                   column(
                       ...
                       row(column(V.file_dialog_string,
                           ...
                           column(row(column(Spacer(height=18),
                                      ...
                                      Spacer(width=(M.gui_width_pix//2-50-5*105)),
                                      column(V.replicates_string, width=105),
