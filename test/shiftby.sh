...
model_parameters='{"representation":"waveform", "window_ms":3.2, "stride_ms":0.8, "mel_dct":"3,3", "dropout_kind": "unit", "dropout_rate": "50", "augment_volume": "1,1", "augment_noise": "0,0", "kernel_sizes": "3,32", "nlayers": "2", "nfeatures": "8,8", "dilate_after_layer": "65535", "stride_after_layer": "2", "connection_type": "plain"}'
