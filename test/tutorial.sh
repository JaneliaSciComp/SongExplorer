...
model_parameters='{"representation":"mel-cepstrum", "window_ms":"6.4", "stride_ms":"1.6", "mel_dct":"7,7", "dropout_kind": "map", "dropout_rate": "50", "augment_volume": "1,1", "augment_noise": "0,0", "kernel_sizes": "5,3", "nlayers": "2", "nfeatures": "64,64", "dilate_after_layer": "65535", "stride_after_layer": "65535", "connection_type": "plain"}'
