...
cp $repo_path/data/PS_20130625111709_ch3.wav-annotated-person1.csv \
   $repo_path/test/scratch/tutorial-sh/groundtruth-data/round1
...
model_parameters='{"representation":"mel-cepstrum","window":"6.4","stride":"1.6","mel_dct":"7,7","range":"","dropout":"50","normalization":"none","kernel_sizes":"5x5,3","nconvlayers":"2","denselayers":"","nfeatures":"64,64","stride_time":"","stride_freq":"","dilate_time":"","dilate_freq":"","pool_kind":"none","pool_size":"","connection_type":"plain"}'
...
cmd="${srcdir}/train \
     ...
     --augmentation_plugin=$augmentation_plugin \
...
cp $repo_path/data/20161207T102314_ch1.wav-annotated-person1.csv \
   $repo_path/test/scratch/tutorial-sh/groundtruth-data/round2
