...
command line method above.
    ...
    $ mkdir -p songexplorer-<version>-<architecture>/songexplorer
    $ tar xvzf songexplorer.tar.gz -C songexplorer-<version>-<architecture>/songexplorer
    $ cp <path-to-songexplorer-repo>/configuration.py songexplorer-<version>-<architecture>
    $ cp <path-to-songexplorer-repo>/app/OPEN-WITH-TERMINAL.sh songexplorer-<version>-<architecture>  # for macOS
    $ cp <path-to-songexplorer-repo>/app/RUN-WITH-POWERSHELL.ps1 songexplorer-<version>-<architecture>  # for Windows
    $ tree -L2 songexplorer-<version>-<architecture>
    songexplorer-v0.9.1-osx-arm64
    ├── configuration.py
    ├── OPEN-WITH-TERMINAL.sh # RUN-WITH-POWERSHELL.ps1 on Windows
    └── songexplorer
        ├── bin
        ├── cmake
        ├── conda-meta
